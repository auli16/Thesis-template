...
\intro{In questo capito viene introdotto il problema per il quale è stato affrontato questo percorso di stage.
...
Viene presentata l'azienda e viene descritta la struttura del documento.}
